  ...
  return (
    <>
      ...
      <div className="search-bar-section">
        {searchBar && (
          <SearchSection
            message={searchingType}
            handlerClosingBox={handlerClosingBox}
          />
        )}
      </div>

      <div
        className={`{${musicExpander}?"background-content":" "} app-component ${
          darkMode ? `dark-mode` : "lite-mode"
        }`}>
        <div>
          ...
          <NavbarTop
            handleModal={handleModal}
            closingStatus={boxClose}
            handlerSearchBar={handlerSearchBar}
            handlerTypingValue={handlerTypingValue}
          />
          ...
          <Routes>
            ...
            <Route
              path="/subscription"
              element={<SubscriptionPage handleModal={handleModal} />}
            />
